---
title: Jekyll + Travis CI + DigitalOcean = <span style="color:#db3a3a;">❤</span>
layout: post
...
(I haven't included the complete `secure` field, as it's very long and doesn't add much value here).
