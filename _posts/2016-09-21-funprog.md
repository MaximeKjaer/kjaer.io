...
For example, let's say we want to find all $$ 1 \leq j < i < n $$ for which $$i+j$$ is prime. This would take two loops in an imperative language, but in Scala we can just write:
